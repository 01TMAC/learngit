...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addUser(){
				document.Form1.action = "${pageContext.request.contextPath}/WEB-INF/jsp/user/add.jsp";
...
&#26597;&#35810;
					...
					<tr>
						<td class="ta_01" align="right">
							<button type="submit" id="add" name="add" value="&#28155;&#21152;" class="button_add" onclick="addUser()">
&#28155;&#21152;
</button>
									...
									<td width="7%" align="center">
										...
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<s:a action="userAction_updateUI.action?userID=%{userID}"><img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand"></s:a>
											</td>
											<td align="center" style="HEIGHT: 22px">
