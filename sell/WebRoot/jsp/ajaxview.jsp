 ...
 <li class='listItem' data-inset="true">
                    <div class="ui-grid-b">
                        <div class="ui-block-a">
                            <img src="/sell/img/1.jpg" class="listImg">
                        </div>
                        <div class="ui-grid-solo">
                            ...
                            <div class="ui-grid-c listBar">
                                <div class="ui-block-a text-right">
                                    <img src="/sell/img/sub.png" class="barImg" name ="<%=goods.getName() %>" onclick="changeStock(this)" >
                                </div>
                                <div class="ui-block-b text-center">
                                    <span class="barNum"></span>
                                </div>
                                <div class="ui-block-c text-left">
                                    <img src="/sell/img/add.png" class="barImg" name = "<%=goods.getName()%>" onclick="changeStock(this)">
                                </div>
