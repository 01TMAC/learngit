    ...
    <div class="cart">
        <div class="ui-grid-d">
            <div class="ui-block-a">
                <a href="#myPopup" data-rel="popup" ><img class="cartImg" src="/sell/img/cart.png" id="cartimg"></a>
            </div>
            ...
            <div class="ui-block-d">
                <img class="detailImg" src="/sell/img/detail.png">
            </div>
            <div class="ui-block-e">
                <button class="submit" onclick="window.location='/sell/order'">下单</button>
            </div>
        </div>
    </div>
