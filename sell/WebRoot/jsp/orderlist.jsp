...
<body>
	<div data-role="page">
		<div data-role="header">
			<a href="./goodlist.jsp" class="ui-btn" style="width: 3px;height:6px;margin-top: 0.4em;" data-rel="back"><img src="/sell/img/back.png" alt="Finland" style="width: 20px;height:20px; margin-top: -0.70em; margin-left:-1em"></a>
			<h2>售货机</h2>
		</div><!--header div-->
